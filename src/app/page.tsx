...
interface PropertyDetailsData extends PropertyData {
    content?: string;
    gallery?: string[];
    customFieldsData?: { [key: string]: any }; // Cambiado a 'any' para simplificar el acceso
}
...
function getPropertyBySlug(slug: string): PropertyDetailsData | null {
    ...
    let customFields: { [key: string]: any } = {}; // Asegurar que siempre sea un objeto
    try {
...
export async function generateStaticParams() {
  // Filtra propiedades sin slug para evitar errores de build
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:sticky lg:top-28">
                 <div className="bg-white p-6 rounded-lg shadow-sm h-fit border border-gray-200">
                    ...
                    {/* Corrección de sintaxis JSX y acceso a customFields */}
