                    ...
                    <ul className="space-y-2 text-sm text-brand-gray">
                        ...
                        {pax && (
                          <li className="flex justify-between items-center">
                            <span className="flex items-center gap-2"><span className="text-md">👥</span> Capacidad:</span>
                            <span className="font-medium">{String(pax)}</span>
                          </li>
                        )}
                        {customFields['acepta-mascota'] && (
                          <li className="flex justify-between items-center">
                            <span className="flex items-center gap-2"><span className="text-md">🐾</span> Mascotas:</span>
                            <span className="font-medium">{String(customFields['acepta-mascota'])}</span>
                          </li>
                        )}
                        {customFields['piscina'] && (
                          <li className="flex justify-between items-center">
                            <span className="flex items-center gap-2"><span className="text-md">🏊</span> Pileta:</span>
                            <span className="font-medium">{String(customFields['piscina'])}</span>
                          </li>
                        )}
